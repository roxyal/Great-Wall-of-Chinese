...
class CreateAccountTest extends TestCase{
    public function testCreateAccountSuccess(){
        ...
        $this -> assertEquals(6, createAccount("correctusername", "correct_name", "valid_email@email.com", "Cz3003234a@sdfasdf", 1, 1));
        //          int 1 on email taken 
        $this -> assertEquals(6, createAccount("correctusername", "correct_name", "taken_email@email.com", "Cz3003234a@sdfasdf", 1, 1));
        //          int 2 on username taken
        $this -> assertEquals(6, createAccount("takenusername", "correct_name", "valid_email@gmail.com", "Cz3003234a@sdfasdf", 1, 1));
        ...
        $this -> assertEquals(6, createAccount("correctusername", "correct_name", "valid_email@gmail.com", "Cz3003234a@sdfasdf", 1, 9999));   
        //          int 5 on server error after writing a value that exceeds what database can enter
        $this -> assertEquals(6, createAccount("correctusername", "correct_name", "valid_email@gmail.com", "Cz3003234a@sdfasdf", 1, 999999999999999));   
